...
public class Sem1_Electrical extends AppCompatActivity {
    ListView listView1;
    String branch;
    String semester;
    Bundle bundle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sem1__electrical);
        bundle=getIntent().getExtras();
        branch=bundle.getString("branch");
        semester=bundle.getString("semester");
        listView1=findViewById(R.id.listView1);
        final String sem1[]=getResources().getStringArray(R.array.electrical_sem1);
        ArrayAdapter<String> arrayAdapter=new ArrayAdapter<String>(Sem1_Electrical.this,android.R.layout.simple_list_item_1,sem1);
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    Intent intent=new Intent(Sem1_Electrical.this,MyRecycler_View.class);
