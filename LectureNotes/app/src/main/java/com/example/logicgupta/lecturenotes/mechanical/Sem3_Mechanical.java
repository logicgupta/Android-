...
public class Sem3_Mechanical extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sem3__mechanical);
        bundle=getIntent().getExtras();
        branch=bundle.getString("branch");
        semester=bundle.getString("semester");
        listView1=findViewById(R.id.listView1);
        final String sem1[]=getResources().getStringArray(R.array.mechanical_sem3);
        ArrayAdapter<String> arrayAdapter=new ArrayAdapter<String>(Sem3_Mechanical.this,android.R.layout.simple_list_item_1,sem1);
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    Intent intent=new Intent(Sem3_Mechanical.this,MyRecycler_View.class);
